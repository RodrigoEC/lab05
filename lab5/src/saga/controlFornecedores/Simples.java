...
public class Simples {
    ...
    /**
     * Método que produz uma representação texutal do objeto do tipo Simples, baseado no nome do produto, descrição e no
     * preço do produto.
     *
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Simples)) return false;
        Simples simples = (Simples) o;
        return descricao.equals(simples.descricao) &&
                nomeProduto.equals(simples.nomeProduto);
    }
